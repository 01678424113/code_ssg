        ...
        <div class="content" style="margin-top: 5%">
            ...
            <div class="form-group">
                <div class="input-icon">
                    ...
                    <input class="form-control" type="text" name="txt-username" placeholder="User name"/>
                </div>
            </div>
            <div class="form-group">
                <div class="input-icon">
                    <i class="fa fa-lock font-blue-dark" style="margin-top: 14px"></i>
                    <input class="form-control" type="password" name="txt-password" placeholder="Password"/>
                </div>
            </div>
            <div class="form-group">
